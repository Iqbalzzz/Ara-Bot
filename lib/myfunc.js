...
exports.serialize = (iqbl, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === iqbl.user.jid ? true : false
    ...
    const conts = msg.key.fromMe ? iqbl.user.jid : iqbl.contacts[msg.sender]
	msg.pushname = msg.key.fromMe ? iqbl.user.name : !conts ? '-' : conts.notify || conts.vname || conts.name || '-'   
